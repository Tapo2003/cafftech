...
?>
<!---<-?$page_title == 'Dashboard' ? 'active-link':'';---->
<!Doctype html>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-8">
                        <div class="sidebar-logo">
                            ...
                            <a href="#"><img src="assets/img/logo/logomin.png" alt="logo-img"></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <ul class="h7_header-top-list">
                                <li><a href="tel:7032290554"><i class="fa-light fa-phone"></i>07032290554</a></li>
                                <li><a href="tel:7050798323"><i class="fa-light fa-phone"></i>07050798323</a></li>
                                <li><a href="mailto:cafftech@gmail.com "><i class="fa-light fa-envelope"></i>cafftech@gmail.com</a></li>
                                <li><a href="#"><i class="fa-light fa-location-dot"></i>IJEDA, OSUN STATE, NIGERIA</a></li>
                            </ul>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xxl-7 col-xl-8 col-lg-6 col-6">
                            <div class="h7_header-left">
                                <div class="h7_header-logo">
                                    <!-- <a href=""><img src="assets/img/logo/logo_.png" alt=""> -->
                                    <a href=""><img src="assets/img/logo/logomin.PNG" alt="" width="" height="40px">
                                    </a>
                                </div>
                        ...
                        <!-- <div class="col-xxl-5 col-xl-4 col-lg-6 col-6">
                            <div class="h7_header-right">
                                <div class="h7_header-search d-none d-xxl-block">
                                    <form action="#">
                                        <input type="text" placeholder="Search Item">
                                        <button type="submit" class="header-search-btn"><i class="fa-thin fa-magnifying-glass"></i></button>
                                    </form>
                                </div>
                                <div class="h7_header-btn2 d-none d-sm-block">
                                    <a href="#" class="h7_header-btn theme-btn theme-btn-medium theme-btn-6">
        ...
        <main>
                ...
                <div class="swiper h7_slider-active">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="h7_single-banner bg-default" style="background-image:url(assets/img/banner/7/1.jpg)">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xl-7 col-lg-8 col-md-11">
                                            <div class="h7_banner-content">
                                                <h1 class="h7_banner-content-title" data-animation="fadeInUp" data-delay="0.3s">Welcome to <br> 
                                                    CAFFTECH</h1>
                                                <p class="h7_banner-content-text" data-animation="fadeInUp" data-delay="0.5s">College of Agriculture Fisheries & Food Technology.</p>
                                                <div class="h7_banner-content-btn" data-animation="fadeInUp" data-delay="0.7s">
                                                    <a href="application.php" class="theme-btn theme-btn-7">Apply Now<i class="fa-light fa-arrow-right"></i></a>
                        ...
                        <div class="swiper-slide">
                            <div class="h7_single-banner bg-default" style="background-image:url(assets/img/banner/7/2.jpg)">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xl-7 col-lg-8 col-md-11">
                                            <div class="h7_banner-content">
                                                <h1 class="h7_banner-content-title" data-animation="fadeInUp" data-delay="0.3s">Welcome to <br> 
                                                    CAFFTECH</h1>
                                                <p class="h7_banner-content-text" data-animation="fadeInUp" data-delay="0.5s">A new agro-based innovation.</p>
                                                <div class="h7_banner-content-btn" data-animation="fadeInUp" data-delay="0.7s">
                                                    <a href="application.php" class="theme-btn theme-btn-7">Apply Now<i class="fa-light fa-arrow-right"></i></a>
                                                    <a href="#" class="theme-btn theme-btn-7 theme-btn-7-yellow">Learn More<i class="fa-light fa-arrow-right"></i></a>
                                                </div>
                        ...
                        <!-- <div class="swiper-slide">
                            <div class="h7_single-banner bg-default" style="background-image:url(assets/img/banner/7/3.jpg)">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xl-7 col-lg-8 col-md-11">
                                            <div class="h7_banner-content">
                        ...
                        <div class="swiper-slide">
                            <div class="h7_single-banner bg-default" style="background-image:url(assets/img/banner/7/4.jpg)">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xl-7 col-lg-8 col-md-11">
                                            <div class="h7_banner-content">
            ...
            <!-- <section class="h7_slider-thumb">
                <div class="swiper h7_slider-active-nav">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="h7_slider-thumb-item" style="background-image:url(assets/img/banner/7/thumb-1.jpg)">
                        ...
                        <div class="swiper-slide">
                            <div class="h7_slider-thumb-item" style="background-image:url(assets/img/banner/7/thumb-2.jpg)">
                                <div class="h7_slider-thumbs-icon">
                        ...
                        <div class="swiper-slide">
                            <div class="h7_slider-thumb-item" style="background-image:url(assets/img/banner/7/thumb-3.jpg)">
                                <div class="h7_slider-thumbs-icon">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="h7_about-wrap mb-50 mr-70">
                                <div class="section-area-6 mb-55">
                                    ...
                                    <!-- <h2 class="section-title mb-15">Experience in School -->
                                        Leadership & Teaching</h2>
                                    <p class="section-text">CAFFTECH farms was established on January 4th, 1984. Over the decades, the firm has achieved notable feats in different fields of Agriculture, ranging from Poultry Science, Fishery, Feed Milling, Cattle Rearing, Agro-processing, and a series of Crop Science, such as Oil Palm, Cocoa, Cashew, Coffee, Banana, Groundnut, Yam, and so on. Most importantly, the Farm birthed the College of Agriculture, Fishery, and Food Technology (CAFFTECH) many years later. </p>
                                </div>
                                <div class="h7_about-content">
                                    <div class="h7_about-admin">
                                        ...
                                        <div class="h7_about-admin-info">
                                            <h5>Otunba (Dr.) Gabriel Emiola Ogunsanya </h5>
                                            <span>Chairman</span>
                                        </div>
                                    </div>
            ...
            <!-- Program area start -->
            <section class="h7_program-area pb-90 fix">
                <div class="program-text-wrap mb-55">
                    <div class="program-text-ticker" id="program-text-ticker">
                        <h1 class="h7_program-title">AGRO-EMPOWERMENT PROGRAMME FOR CAFFTECH STUDENTS</h1>
                    </div>
                </div>
                <div class="container">
                    <div class="h7_program-wrap">
                        <div class="row g-0">
                            <div class="col-xl-4 col-lg-4">
                                <div class="h7_program-item">
                                    <h3 class="h7_program-item-title">Undergraduate</h3>
                                    <p>Our undergraduate programs is tailored to meet the unique needs of student who are seeking to gain admission in agro-technology colloge.</p>
                                    <ul class="h7_program-item-list2">
                                        <li>Farm</li>
                                        <li>College</li>
                                    </ul>                                    
                                    <!-- <div class="h7_program-item-list">
                                        <a href="#">FARM <i class="fa-light fa-arrow-right"></i></a>
                                        <a href="#">COLLEGE <i class="fa-light fa-arrow-right"></i></a>
                                    </div> -->
                                    <!-- <span class="h7_program-item-time"><i class="fa-light fa-clock"></i> Online + Onsite</span> -->
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4">
                                <div class="h7_program-item h7_program-item2">
                                    <h3 class="h7_program-item-title">SPECIAL FARM SCIENCE</h3>
                                    <p>Our specialized programs</p>
                                    <ul class="h7_program-item-list2">
                                        <li>Ranching: modernized method of cattle rearing</li>
                                        <li>Processing: modern method of extracting milk</li>
                                        <li>Cross-breeding – artificial insemination </li>
                                        <li>How to plant modern grasses for animal feeding</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4">
                                <div class="h7_program-item">
                                    <h3 class="h7_program-item-title">Online Education</h3>
                                    <p>Learning at CAFFTECH is flexible with our online education platform</p>
                                    <ul class="h7_program-item-list2">
                                        <li>Farm</li>
                                        <li>College</li>
                                    </ul>                                       
                                    <!-- <div class="h7_program-item-list">
                                        <a href="#">Undergraduate Programs <i class="fa-light fa-arrow-right"></i></a>
                                        <a href="#">Graduate Programs <i class="fa-light fa-arrow-right"></i></a>
                                    </div>
                                    <span class="h7_program-item-time"><i class="fa-light fa-clock"></i> Online + Onsite</span>
            ...
            <!-- apply area start -->
            <section class="h7_apply-area pt-10 pb-95 fix">
                <div class="apply-text-wrap mb-80">
                    <div class="apply-text-ticker">
                        <h1 class="h7_apply-title animate-charcter">Apply Now</h1>
                    </div>
                </div>
                <div class="container">
                    <div class="h7_apply-wrap">
                        <div class="h7_apply-item">
                            <div class="h7_apply-item-number">
                                <span>01</span>
                            </div>
                            <div class="h7_apply-item-title">
                                <h4>You Apply</h4>
                            </div>
                            <div class="h7_apply-item-text">
                                <p>You can apply by <a href="application.php"><u style="color:red">clicking</u></a> to fill the online application form and upload your credentials,</p>
                            </div>
                            <div class="h7_apply-item-img">
                        ...
                        <div class="h7_apply-item">
                            ...
                            <div class="h7_apply-item-text">
                                <p>Applicants who scale through are shortlisted for admission,</p>
                            </div>
                            <div class="h7_apply-item-img">
                        ...
                        <div class="h7_apply-item">
                            ...
                            <div class="h7_apply-item-text">
                                <p>Finally, you can now get prepared for the programme.</p>
                            </div>
                            <div class="h7_apply-item-img">
                                <!-- <img src="assets/img/apply/7/3.png" alt=""> -->
                            </div>
                        </div>
                        <!-- <a href="#" class="h7_apply-wrap-btn">View All Requirements</a> -->
                    </div>
                </div>
            </section>
            <!-- apply area end -->
                            ...
                            <div class="h7_counter-item justify-content-xl-start justify-content-center mb-10">
                                <div class="h7_counter-info">
                                    <h3 class="h7_counter-info-title">
                                        <span class="odometer count_one" data-count="83">00</span>
                                        <span>%</span>
                                    </h3>
                                    <span class="h7_counter-info-text">OF RECENT GRADUATES <br> STARTED NEW JOB</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="h7_counter-item justify-content-center mb-10">
                                <div class="h7_counter-info">
                                    <h3 class="h7_counter-info-title">
                                        <span class="odometer count_one" data-count="125">00</span>
                                        <span>+</span>
                                    </h3>
                                    <span class="h7_counter-info-text">University DEGREE PROGRAMS</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="h7_counter-item justify-content-center mb-10">
                                <div class="h7_counter-info">
                                    ...
                                    <span class="h7_counter-info-text">YEARS OF HISTORY</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="h7_counter-item justify-content-xl-end justify-content-center mb-10">
                                <div class="h7_counter-info">
                                    <h3 class="h7_counter-info-title">
                                        <span class="odometer count_one" data-count="345">00</span>
                                        <span>+</span>
                                    </h3>
                                    <span class="h7_counter-info-text">Our University Lecture</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- <section class="h6_campus-area fix">
                <div class="h6_campus-wrap">
                    <div class="h6_campus-item-1">
                        ...
                        <div class="campus-text-wrap">
                            <div class="campus-text-ticker" id="campus-text-ticker">
                                <h1 class="h6_campus-title">Embrace the campus spirit</h1>
                            </div>
                        </div>
                    </div>
                    <div class="h6_campus-item-2">
                        ...
                        <ul>
                            <li><a href="#">Athletics Fitness <i class="fa-light fa-arrow-right"></i></a></li>
                            <li><a href="#">Support & Guidance <i class="fa-light fa-arrow-right"></i></a></li>
                            <li><a href="#">Student activities <i class="fa-light fa-arrow-right"></i></a></li>
                        </ul>
                    </div>
                    <div class="h6_campus-item-3">
                        ...
                        <div class="campus-text-wrap-2">
                            <div class="campus-text-ticker-2" id="campus-text-ticker-2">
                                <h1 class="h6_campus-title">Embrace the campus rhythm</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-xl-5">
                            <div class="h6_tuition-content mb-45">
                                ...
                                <h2>Tuition & Fees</h2>
                                <p>Our tuition fee is moderately cheap and <br> we have a friendly payment plan.</p>
                        ...
                        <div class="col-xl-7">
                            <div class="h6_tuition-wrap mb-50">
                                <div class="h6_tuition-item">
                                    <span class="h6_tuition-item-date">2023-2024 Session</span>
                                    <h4 class="h6_tuition-item-title">Tuition Costs</h4>
                                    <ul class="h6_tuition-item-list">
                                        <li>Application form<span>#5,000</span></li>
                                        <li>Aceptance fee<span>#15,000</span></li>
                                        <li>School fee<span>#150,000</span></li>
                                    </ul>
                                    <p class="h6_tuition-item-total"><span>Total :</span> <span>#170,000</span></p>
                                </div>
            ...
            <!-- <section class="h7_scholarship-area fix">
                <div class="container">
                    <div class="h7_scholarship-img">
                        <img src="assets/img/scholarship/7/1.jpg" alt="">
                    </div>
                </div>
                <div class="h7_scholarship-wrap">
                    <div class="container p-relative">
                        <div class="h7_scholarship-title">
                            <h1>
                                <span class="wow slideInLeft"  data-wow-duration="2s">Scholarship</span> 
                                <span class="wow slideInRight scholar-bottom"  data-wow-duration="2s" data-wow-delay=".1s">Programs</span>
                            </h1>
                        </div>
                        <div class="h7_scholarship-content">
                            <p>At Kempbelle University, we prepare you to launch your career by providing a supportive, creative, and professional environment</p>
                            <a href="#">Financial Aid <i class="fa-light fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </section> -->
            ...
            <!-- blog area start -->
            <!-- <section class="h5_blog-area h6_blog-area pt-110 pb-90">
                <div class="container">
                    <div class="row align-items-end mb-30">
                        ...
                        <div class="col-md-3">
                            <div class="h5_category-section-button mb-40 text-md-end">
                                <a href="#" class="theme-btn theme-btn-medium theme-btn-5">View All Blog</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="h5_blog-item mb-30 active">
                                <div class="h5_blog-content">
                                    <div class="h5_blog-content-meta">
                                        <a href="#" class="h5_blog-content-meta-tag">Blog</a>
                                        <span>March 24, 2023</span>
                                    </div>
                                    <h5 class="h5_blog-content-title"><a href="blog-details.html">Four Ways to Keep Your Workout Routine Fresh</a></h5>
                                    <p>Maecenas Felis Tellus, dictum sed pharetra fermentum......</p>
                                    <a href="#" class="h5_blog-btn"><svg xmlns="http://www.w3.org/2000/svg" width="auto" height="auto" x="0" y="0" viewBox="0 0 512 512" ><g><path d="m506.134 241.843-.018-.019-104.504-104c-7.829-7.791-20.492-7.762-28.285.068-7.792 7.829-7.762 20.492.067 28.284L443.558 236H20c-11.046 0-20 8.954-20 20s8.954 20 20 20h423.557l-70.162 69.824c-7.829 7.792-7.859 20.455-.067 28.284 7.793 7.831 20.457 7.858 28.285.068l104.504-104 .018-.019c7.833-7.818 7.808-20.522-.001-28.314z" fill="currentColor" class=""></path></g></svg></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="h5_blog-item mb-30">
                                <div class="h5_blog-content">
                                    ...
                                    <h5 class="h5_blog-content-title"><a href="blog-details.html">The Complete Guide to Build RESTful API Application</a></h5>
                                    <p>Maecenas Felis Tellus, dictum sed pharetra fermentum......</p>
                                    <a href="#" class="h5_blog-btn"><svg xmlns="http://www.w3.org/2000/svg" width="auto" height="auto" x="0" y="0" viewBox="0 0 512 512" ><g><path d="m506.134 241.843-.018-.019-104.504-104c-7.829-7.791-20.492-7.762-28.285.068-7.792 7.829-7.762 20.492.067 28.284L443.558 236H20c-11.046 0-20 8.954-20 20s8.954 20 20 20h423.557l-70.162 69.824c-7.829 7.792-7.859 20.455-.067 28.284 7.793 7.831 20.457 7.858 28.285.068l104.504-104 .018-.019c7.833-7.818 7.808-20.522-.001-28.314z" fill="currentColor" class=""></path></g></svg></a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="h5_blog-item mb-30">
                                <div class="h5_blog-content">
                                    ...
                                    <h5 class="h5_blog-content-title"><a href="blog-details.html">Only One Thing Impossible For God Find Sense in Any.</a></h5>
                                    <p>Maecenas Felis Tellus, dictum sed pharetra fermentum......</p>
                                    <a href="#" class="h5_blog-btn"><svg xmlns="http://www.w3.org/2000/svg" width="auto" height="auto" x="0" y="0" viewBox="0 0 512 512" ><g><path d="m506.134 241.843-.018-.019-104.504-104c-7.829-7.791-20.492-7.762-28.285.068-7.792 7.829-7.762 20.492.067 28.284L443.558 236H20c-11.046 0-20 8.954-20 20s8.954 20 20 20h423.557l-70.162 69.824c-7.829 7.792-7.859 20.455-.067 28.284 7.793 7.831 20.457 7.858 28.285.068l104.504-104 .018-.019c7.833-7.818 7.808-20.522-.001-28.314z" fill="currentColor" class=""></path></g></svg></a>
                                </div>
                            </div>
            ...
            <!-- event area start -->
            <!-- <section class="event-area h7_event-area">
                <img src="assets/img/event/7/bg.jpg" alt="" class="event-bg-img">
                                ...
                                <div class="event-navigation mb-30">
                                    <div class="event-prev">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15 8H1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M8 1L1 8L8 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>                                            
                                    </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="event-item">
                                        <div class="event-img">
                                            <a href="event.html"><img src="assets/img/event/1/1.jpg" alt=""></a>
                                        </div>
                                        <div class="event-content">
                                            ...
                                            <h5 class="event-content-title"><a href="event.html">These are Designed to Provide Hands Training and Skill-Building.</a></h5>
                                ...
                                <div class="swiper-slide">
                                    <div class="event-item">
                                        <div class="event-img">
                                            <a href="event.html"><img src="assets/img/event/1/2.jpg" alt=""></a>
                                        </div>
                                        <div class="event-content">
                                            <div class="event-content-meta">
                                                <span><i class="fa-thin fa-location-dot"></i>London, US</span>
                                            ...
                                            <h5 class="event-content-title"><a href="event.html">Personalized Learning & Meeting The Needs of Every Student.</a></h5>
                                            <a href="#" class="t-theme-btn theme-btn event-btn">Get Ticket</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="event-item">
                                        <div class="event-img">
                                            <a href="event.html"><img src="assets/img/event/1/3.jpg" alt=""></a>
                                        </div>
                                        <div class="event-content">
                                            <div class="event-content-meta">
                                                <span><i class="fa-thin fa-location-dot"></i>London, US</span>
                                            ...
                                            <h5 class="event-content-title"><a href="event.html">The Whole Child Fostering Social and Emotional Development.</a></h5>
                                            <a href="#" class="t-theme-btn theme-btn event-btn">Get Ticket</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <!-- <section class="h6_testimonial-area pt-120 pb-120 bg-default pt-215 pb-100 fix" style="background-image:url(assets/img/testimonial/6/1.jpg)">
                <div class="testimonial-text-wrap mb-80">
                    <div class="testimonial-text-ticker" id="testimonial-text-ticker">
                        <h1 class="h6_testimonial-title">Outstanding Clients care</h1>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="h6_testimonial-item">
                                                <blockquote>
                                                    <p>One aspect that truly stood out for me was the research opportunities. Eduan University has state-of-the-art labs and facilities, and I had the chance to work on cutting-edge research projects alongside professors.</p>
            ...
            <div class="h6_cta-area pt-120">
                <div class="container">
                    <div class="h6_cta-wrapper" style="background-image:url(assets/img/cta/7/takeastep.jpg)">
                        ...
                        <div class="h6_cta-button">
                            <a href="application.php" class="h6_cta-btn">Application Form<i class="fa-light fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
